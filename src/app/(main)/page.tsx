...
export default async function HomePage() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-zinc-950 text-zinc-100 overflow-x-hidden font-sans">
        ...
        <div className="relative z-20 max-w-7xl mx-auto h-full flex flex-col justify-center px-6">
          <div className="max-w-3xl space-y-8">
            ...
            <h1 className="text-8xl lg:text-9xl font-extrabold font-heading text-white tracking-tighter leading-[0.85] uppercase">
              ELITE HUBS<br />
              <span className="bg-gradient-to-r from-brand-blue via-brand-green to-teal-400 bg-clip-text text-transparent drop-shadow-2xl">ON-DEMAND</span>
            </h1>
            
            <p className="text-xl text-zinc-400 font-medium max-w-xl leading-relaxed opacity-80 pl-2">
              Instant access to India&apos;s most premium fitness centers. No memberships. No commitments. Just pure performance.
            </p>

            <div className="flex items-center space-x-6 pt-6">
              <Link href="/explore" className="bg-gradient-to-r from-brand-blue to-brand-green text-white font-bold px-12 py-6 rounded-[2rem] shadow-[0_20px_50px_rgba(59,130,246,0.3)] flex items-center space-x-4 hover:scale-105 active:scale-95 transition-all uppercase tracking-[0.2em] text-xs group">
      ...
      <div className="max-w-7xl mx-auto w-full px-6 py-12 md:py-24 space-y-24">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 border-b border-white/5 pb-12">
          <div className="space-y-4">
            ...
            <p className="text-zinc-500 text-sm font-medium opacity-70">Hand-picked elite centers with verified PassFit protocols in <span className="text-white font-bold underline decoration-brand-green decoration-2 underline-offset-4">INDORE</span></p>
          </div>
          <Link href="/explore" className="inline-flex items-center space-x-3 text-[10px] font-bold uppercase tracking-[0.3em] text-zinc-500 hover:text-brand-green transition-colors group">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-10">
          {gyms.length > 0 ? gyms.map((gym) => (
            ...
            <div className="col-span-full py-32 text-center border-2 border-dashed border-white/5 rounded-[4rem] bg-zinc-900/20">
               <p className="text-zinc-700 font-bold text-sm uppercase tracking-[0.5em]">Initializing Elite Partner Network...</p>
            </div>
          )}
        </div>
        ...
        <div className="relative rounded-[4rem] overflow-hidden bg-zinc-900 p-16 md:p-24 border border-white/5 flex flex-col lg:flex-row items-center justify-between gap-16 group cursor-pointer hover:border-brand-green/30 transition-all shadow-3xl">
          ...
          <div className="relative z-10 space-y-8 max-w-2xl">
             <div className="inline-flex items-center space-x-3 px-4 py-2 rounded-full bg-white/5 border border-white/10 uppercase text-[9px] font-bold tracking-widest text-zinc-400">
      ...
      <footer className="max-w-7xl mx-auto w-full px-6 py-20 border-t border-white/5 text-center mt-20 opacity-40">
         <p className="text-[10px] text-zinc-600 font-bold uppercase tracking-[1em]">Premium Gym Marketplace v2.4.9 • Powered by Aiclex Technologies</p>
      </footer>
    </div>
  );
}
